...
TEST(TestMatrixd2x2d, rotation)
{
    {
        const double angle = 0.0;
        const Matrix2x2d m = MathLib::rotation(angle);
...
TEST(TestMatrixd2x2d, scale)
{
    const Vector2d scale(1.0, 2.0);
    {
        const Matrix2x2d m = MathLib::scale(scale.getX(), scale.getY());
    ...
    {
        const Matrix2x2d m = MathLib::scale(scale);
