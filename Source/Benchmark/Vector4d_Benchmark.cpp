...
namespace
{
    ...
    void BM_Vector4dDot(benchmark::State& _state)
    {
    ...
    void BM_Vector4dDot_Array(benchmark::State& _state)
    {
    ...
    void BM_Vector4dDot_Array_Aligned(benchmark::State& _state)
    {
    ...
    void BM_Vector4dDot_Array_Aligned_NoFalseSharing(benchmark::State& _state)
    {
        constexpr size_t size = 1024;
    ...
    void BM_Vector4dDot_Array_Aligned_NoFalseSharing_ToArray(benchmark::State& _state)
    {
        constexpr size_t size = 1024;
        Vector4d* arrayA = alignMalloc<Vector4d>(size, HardwareDestructiveInterferenceSize);
        Vector4d* arrayB = alignMalloc<Vector4d>(size, HardwareDestructiveInterferenceSize);
